...
export const mount = (selector: string) => {
  ...
  const create = () => {
    ...
    const child = (
      <div class="fixed top-[84px] left-[4px] bg-modal p-2 rounded shadow-lg md:shadow-none md:left-[100px] md:top-[88px] <md:[&:focus-within_.outlines]:flex flex flex-col <md:w-auto w-[240px]">
        <div class="flex <md:justify-start" tabIndex={-1}>
